...
function StepIcon({ name }) {
  if (name === 'camera') {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M4 7.5A2.5 2.5 0 0 1 6.5 5h2l1.2-1.5h4.6L15.5 5h2A2.5 2.5 0 0 1 20 7.5v9a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 16.5v-9Z"/>
  ...
  if (name === 'scan') {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M4 8V5a1 1 0 0 1 1-1h3M16 4h3a1 1 0 0 1 1 1v3M20 16v3a1 1 0 0 1-1 1h-3M8 20H5a1 1 0 0 1-1-1v-3M7 12h10M9 9.5h6M9 14.5h6"/>
      </svg>
    )
  }
  return (
    ...
    <main>
      ...
      <section className="hero page-container">
        ...
        >
          ...
          <p>
            NilaFresh menganalisis citra mata dan insang secara terpisah,
            lalu merangkum keduanya menjadi hasil yang mudah dipahami.
          </p>
      ...
      <section id="cara-kerja" className="process-section">
        <div className="page-container">
          ...
          >
            ...
            <h2>Proses singkat, hasil transparan.</h2>
            <p>Setiap tahap dirancang agar hasil tiap organ tetap dapat dibaca, bukan hanya keputusan akhirnya.</p>
          </motion.div>
            ...
            {steps.map((step) => (
              ...
              >
                <div className="step-card-top">
                  <span className="step-icon"><StepIcon name={step.icon} /></span>
      ...
      <section id="tentang" className="about-section page-container">
        ...
        <div>
          <p>
            NilaFresh dikembangkan sebagai bagian dari penelitian klasifikasi kesegaran ikan nila.
            Dua model citra khusus digunakan agar kondisi mata dan insang tidak tercampur dalam satu asumsi visual.
          </p>
          <p className="tech-line">FastAPI · React · TensorFlow · ResNet50</p>
        </div>
      </section>
