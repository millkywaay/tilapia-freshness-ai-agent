    ...
    try {
      ...
      setError(
        typeof detail === 'string'
          ? detail
          : 'Analisis gagal. Pastikan backend berjalan dan coba kembali.',
      )
    } finally {
      setLoading(false)
    }
  ...
  return (
    <main className="detect-page page-container">
      <div className="page-heading">
        ...
        <p>
          Gunakan dua foto yang terang dan fokus. Setiap organ dianalisis
          secara terpisah sebelum hasilnya digabungkan.
        </p>
      </div>
      ...
      <div className="upload-grid">
        <UploadCard
          label="Foto mata"
          description="Ambil foto dekat pada area mata ikan."
          hint="Pastikan mata terlihat jelas, fokus, dan tidak terpotong."
          file={eyeFile}
        ...
        <UploadCard
          ...
          hint="Pastikan seluruh area insang terlihat dan fokus."
          file={gillFile}
      ...
      <div className="analysis-panel">
        <div>
          <strong>
            {bothReady ? '✓ Kedua foto siap dianalisis' : 'Diperlukan dua foto'}
          </strong>
          <span>Format gambar akan disiapkan otomatis oleh sistem.</span>
        </div>
        <button
          type="button"
          className="button"
      ...
      <div ref={resultRef}>
        {result && <ResultSummary prediction={result} onReset={handleReset} />}
      </div>
    </main>
  )
}
